        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text('Here are a few agents:', style: TextStyle(
                fontFamily: 'Cera Pro',
                color: Pallete.mainFontColor,
            ...
            Column(
              children: [
                ...
                FeatureBox(color: Pallete.thirdSuggestionBoxColor, headerText: 'Smart Voice Assistant- Romi', descriptionText: 'Get the best of both worlds with a voice assistant powered by Chat-GPT and Dall-E.',
                ),
              ],
